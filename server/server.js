...
require("./app/routes/visitingPlace.routes")(app);
require("./app/routes/visitingPlaceAsessment.routes")(app);
require("./app/routes/imageAssessVisitingPlace.routes")(app);
require("./app/routes/imageVisitingPlace.routes")(app);
